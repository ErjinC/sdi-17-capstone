...
const CreateListing = () => {
  ...
  const vehicleTypeSelect = (
    <div id='descriptionTextContainer'>
      ...
      <Button background='#023047' colorScheme='blue' size='md' value='car' onClick={assignVehicleHandler}>Car</Button>
      <Button background='#023047' colorScheme='blue' size='md' value='motorcycles' onClick={assignVehicleHandler}>Motorcycle</Button>
      <Button background='#023047' colorScheme='blue' size='md' value='rvs' onClick={assignVehicleHandler}>RV</Button>
      <Button background='#023047' colorScheme='blue' size='md' value='boats' onClick={assignVehicleHandler}>Boat</Button>
      <Button background='#023047' colorScheme='blue' size='md' value='trailers' onClick={assignVehicleHandler}>Trailer</Button>
      <p className='centered'> Or go back to...</p>
      <Button background='#023047' colorScheme='blue' size='md'onClick={() => navigate('/listings')}>Your Listings</Button>
    </div>
  )
