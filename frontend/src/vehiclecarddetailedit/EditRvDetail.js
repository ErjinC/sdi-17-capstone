    ...
    <ChakraProvider>
      <div id='detailFlexContainer'>
        ...
        <div id="detailsContainer">
          ...
          {editToggle ? <div className='detailItem'><span id="icon" class="material-symbols-outlined">sell</span>Price:&nbsp;<input className='editInput' type='number' defaultValue={vehicle.price}  onChange={(e) => setEditPrice(Number(e.target.value))}/></div>  : <div className='detailItem'><span id="icon" class="material-symbols-outlined">sell</span>{' $'+vehicle.price}</div>}
          {vehicle.type === 'towable' ?
            editToggle ? <div className='detailItem'><span id="icon" class="material-symbols-outlined">speed</span>Weight:&nbsp;<input className='editInput' type="number" defaultValue={vehicle.weight} onChange={(e) => setEditWeight(Number(e.target.value))}/></div> : <div className='detailItem'><span id="icon" class="material-symbols-outlined">weight</span> {vehicle.weight + ' lbs'}</div>
            :
          ...
          {editToggle ? <div className='detailItem'><span id="icon" class="material-symbols-outlined">straighten</span>Length:&nbsp;<input className='editInput' type="number" defaultValue={vehicle.length} onChange={(e) => setEditLength(Number(e.target.value))}/></div> : <div className='detailItem'><span id="icon" class="material-symbols-outlined">straighten</span> {vehicle.length + ' ft.'}</div>}
          {editToggle?<></>:<div className='detailItem'><span id="icon" class="material-symbols-outlined">airport_shuttle</span> {vehicle.type.charAt(0).toUpperCase()+ vehicle.type.slice(1)}</div>}
          ...
          {editToggle ? <div className='vehicle-changes-container'>
